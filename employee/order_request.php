...
<section >
  ...
  <div id="main-body" >
   ...
   $query = $conn->query("SELECT * FROM sales WHERE shipment_status != 'Ready For Shipment' AND shipment_status != 'Product Delivered' AND shipment_status != 'Product Received' order by `s_id` DESC") or die();
