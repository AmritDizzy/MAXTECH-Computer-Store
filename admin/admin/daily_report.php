...
$checkdate = $conn-> query("SELECT * FROM sales_info WHERE `date` Like '$date%' order by id asc");
...
<h3>     Total Item Sold : <?= $total_quantity ?>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  Total Sell  : <?= $sum_loan ?> TTD  &nbsp;   (<?= $date ?> )  </h3>
